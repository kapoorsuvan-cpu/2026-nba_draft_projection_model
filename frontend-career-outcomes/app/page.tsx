        ...
        <div className="mb-10 grid gap-6 lg:grid-cols-[1.35fr_0.65fr]">
          <div>
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-sm text-slate-600">
              <Brain size={16} />
              Career Outcomes Experiment
            </div>
            <h1 className="max-w-5xl text-4xl font-semibold tracking-tight md:text-6xl">
              2026 NBA draft career-outcome dashboard
            </h1>
            <p className="mt-5 max-w-3xl text-lg leading-8 text-slate-600">
              Explore projections from position-specific, tuned models whose features are selected
              with train-only correlation and mutual-information analysis. Rotation now requires a
              meaningful role that persisted beyond the rookie-contract window.
            </p>
          </div>
            ...
            return (
              <Card key={pos}>
                ...
                <div className="mt-3 grid grid-cols-4 gap-2 text-xs">
                  <div>
                    <div className="text-slate-500">Test F1</div>
                    <div className="font-semibold">{num(m.macro_f1, 3)}</div>
                  </div>
                  <div>
                    <div className="text-slate-500">CV F1</div>
                    <div className="font-semibold">{num(m.cv_macro_f1, 3)}</div>
                  </div>
                  <div>
          ...
          <Card>
            ...
            <div className="grid gap-6 text-sm leading-6 text-slate-600 md:grid-cols-4">
              <div>
                ...
                <p>
                  Star means a career All-Star or All-NBA selection, or a max contract. Rotation
                  requires two 40-game, 15-MPG seasons, including one in NBA year five or later.
                </p>
              </div>
              <div>
                <div className="mb-2 font-semibold text-slate-950">2. Train-only features</div>
                <p>
                  Correlation, mutual information, and redundancy checks choose different safe college
                  and recruiting features for Guards, Forwards, and Centers using training years only.
                </p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>
                  Contract values are unavailable from nba_api, so max-contract Star labels require an
                  enriched contract feed. Small test samples still create substantial uncertainty.
                </p>
              </div>
            </div>
          </Card>
